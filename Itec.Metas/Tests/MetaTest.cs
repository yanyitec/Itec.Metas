...
namespace Itec.Metas.Tests
{
    ...
    class MetaTest
    {
        ...
        static void GetterTest()
        {
            ...
            var propId = new MetaProperty(fields.First(p => p.Name == "Id"));
            var id = propId.GetValue(user);
            Console.WriteLine("Get Id Value:" + id);

            var propName = new MetaProperty(typeof(User).GetProperties().First(p => p.Name == "Name"));
        ...
        static void SetterTest()
        {
            ...
            //Nullable
            var propAge = new MetaProperty(props.First(p => p.Name == "Age"));
            ...
            //gender
            var propGender = new MetaProperty(props.First(p => p.Name == "Gender"));
            ...
            var propName = new MetaProperty(props.First(p => p.Name == "Name"));
            ...
            var propArticle = new MetaProperty(fields.First(p => p.Name == "Article"));
        ...
        static void Copy()
        {
            ...
            var cls = new MetaClass(typeof(User));
